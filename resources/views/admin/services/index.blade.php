            ...
            <div class="card">
              <div class="card-header d-flex justify-content-end">
                <div class="card-title pull-right">
                  <a href="{{ url('admin/services/create')}}" class="btn bg-success"><i class="fa fa-plus"></i> Add Service</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table class="table table-bordered table-striped datatable">
                  <thead>
                    <tr> 
                      ...
                      <th class="statuswidth">IsFeatured</th>
...
<script type="text/javascript">
    ...
    $.ajaxSetup({
      ...
      tableObj = $('.datatable').DataTable({
          ...
          columns   : [ 
            ...
            { data : 'is_featured','searchable':false, 'orderable':false },
  ...
  $("body").on("change",".tgl_checkbox",function(){ 
    $.post('{{ url("admin/services/status") }}',
    {
      _token:"{{ csrf_token() }}",
      id : $(this).data('id'),
    ...
    $.post('{{ url("admin/services/feature") }}',
    {
      _token:"{{ csrf_token() }}",
      id : $(this).data('id'),
      status : $(this).is(':checked') == true?1:0
