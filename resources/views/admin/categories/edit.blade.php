                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <select name="parent_id" id="parent_id" class="form-control">
                      ...
                      <option value="0" <?php if (old('parent_id', $data->parent_id) == 0) {
                                          echo 'selected';
                                        } ?>>Parent</option>
                      @foreach ($parcat as $key => $pcat)
                      @if ($pcat['id']<=$data->parent_id)
                        <option value="{{ $pcat['id'] }}" <?php if (old('parent_id', $data->parent_id) == $pcat['id']) {
                                                            echo 'selected';
                                                          } ?>>{{ $pcat['name'] }}</option>
                        @endif
                        @endforeach
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <textarea id="sort_description" name="sort_description" class="form-control" rows="4" id="sort_description">{{ old('sort_description',$data->sort_description) }} </textarea>
