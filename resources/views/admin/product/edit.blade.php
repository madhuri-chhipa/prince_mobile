      ...
      <div class="row">
         <div class="col-12">
            <div class="card">
               ...
               <form id="accessoryForm" method="post" action="{{ url('admin/product', ['id' => $data->id]) }}" enctype="multipart/form-data">
                  @method('PUT')
                  @csrf
                  <div class="card-body">
                     <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                           <button class="nav-link" id="Specification-tab" data-bs-toggle="tab" data-bs-target="#Specification" type="button" role="tab" aria-controls="Specification" aria-selected="false">Category</button>
                        </li>
                        <li class="nav-item" role="presentation">
                     ...
                     <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                           <div class="row">
                              <div class="col">
                                 <div class="form-group">
                                    <label for="manufacture_id">Manufacture Name<i class="text-danger">*</i></label>
                                    <select name="manufacture_id" id="manufacture_id" class="form-control">
                                       <option value="{{ old('manufacture_id', $data->manufacture_id) }}">{{ $data->manufacture_name }}</option>
                                       @foreach ($manufactures as $manufacture)
                                       <option value="{{ $manufacture->id }}">{{ $manufacture->name }}</option>
                                       @endforeach
                                    </select>
                                    <label class="error">{{ $errors->first('manufacture_id') }}</label>
                                 </div>
                              </div>
                              <div class="col">
                                 <div class="form-group">
                           ...
                           <div class="row">
                              ...
                              <div class="col">
                                 <div class="form-group">
                                    <label for="offer_price">Offer price<i class="text-danger">*</i></label>
                                    <input type="text" name="offer_price" class="form-control" value="{{ old('offer_price',$data->offer_price) }}" id="offer_price" placeholder="Enter Offer Price">
                                    <label class="error">{{ $errors->first('offer_price') }}</label>
                                 </div>
                              </div>
                           </div>
                           <div class="row">
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="default_image" id="default_image" accept="image/*">
                                    ...
                                    <p><img src="{{ asset($data->default_image) }}" class="image logosmallimg">
                                    </p>
                                    @endif
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label for="sort_description">Sort Description<i class="text-danger">*</i></label>
   ...
   $(document).ready(function() {
      ...
      $("#accessoryForm").validate({
         ...
         messages: {
            ...
            sort_description: {
               required: "Please Enter Product Sort Description",
               maxlength: "Product Sort Description should be less than or equal to 250 characters",
            },
