      ...
      <div class="row">
         <div class="col-12">
            <div class="card">
               ...
               <form id="accessoryForm" method="post" action="{{ url('admin/product') }}" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                           ...
                           <div class="row">
                              <div class="col">
                                 <div class="form-group">
                                    ...
                                    <label class="error">{{ $errors->first('manufactue_id') }}</label>
                                 </div>
                              </div>
                              <div class="col">
                                 <div class="form-group">
                           ...
                           <div class="row">
                              ...
                              <div class="col">
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="offer_price" class="form-control" value="{{ old('offer_price') }}" id="offer_price" placeholder="Enter Offer Price">
