        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <form id="offerForm" method="post" action="{{ url('admin/offer') }}"  enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" value="{{ old('title') }}" id="title" placeholder="Enter offer title">
