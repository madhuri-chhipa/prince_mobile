          ...
          <div class="card">
            <div class="card-header d-flex justify-content-end">
              <div class="card-title pull-right">
                <a href="{{ url('admin/offer') }}" class="btn btn-success"><i class="fa fa-list"></i>  offer Lists</a>
              </div>
            </div>
            <form id="offerForm" method="post" action="{{ url('admin/offer', ['id' => $data->id]) }}"  enctype="multipart/form-data">
              @method('PUT')
              @csrf
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="title">Offer Title<i class="text-danger">*</i></label>
                        <input type="text" name="title" class="form-control" value="{{ old('title', $data->title) }}" id="title" placeholder="Enter offer title">
